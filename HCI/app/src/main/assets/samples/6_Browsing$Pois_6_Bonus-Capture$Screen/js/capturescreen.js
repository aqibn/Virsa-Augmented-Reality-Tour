...
var World = {
	...
	manualLocationCoordinates: null,
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		World.markerDrawable_idle = new AR.ImageResource("assets/selected.png");
		World.markerDrawable_selected = new AR.ImageResource("assets/idle.png");
	...
	*/
	...
	locationChanged: function locationChangedFn(lat, lon, alt, acc) {
		...
		alert("In manual");
		World.userLocation = World.manualLocationCoordinates;
	}
	...
	onMarkerSelected: function onMarkerSelectedFn(marker) {
		...
		$("#poi-detail-distance").html("Distance: " +distanceToUserValue);
		// show panel
	...
	setManualLocation: function setManualLocationFn() {
			...
			// open panel
			$("#bottomsheetlist").trigger("updatelayout");
			$("#bottomsheetlist").panel("open", 1234);
		
	},
	setAutoLocation: function setAutoLocationFn() {
		alert('set Auto Location');
		World.manualLocation = false;
	},
	setLocation: function setLocationFn(position){
		World.manualLocation = true;
		World.locationUpdateCounter = 0;
		alert("Set Manual Location " + position);
		if (position == 1) {
			World.manualLocationCoordinates = {
			'latitude': 31.472286,
			'longitude': 74.410961,
			'altitude': 100,
			'accuracy': 10
		};
		World.locationChanged(31.472286,74.410961,100,10);
